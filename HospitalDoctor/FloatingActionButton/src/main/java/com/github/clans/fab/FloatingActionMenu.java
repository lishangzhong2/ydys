...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMenuColorNormal = attr.getColor(R.styleable.FloatingActionMenu_menu_colorNormal, Color.parseColor("#1565C0"));
        mMenuColorPressed = attr.getColor(R.styleable.FloatingActionMenu_menu_colorPressed, Color.parseColor("#2272CD"));
        mMenuColorRipple = attr.getColor(R.styleable.FloatingActionMenu_menu_colorRipple, Color.parseColor("#62B2FF"));
