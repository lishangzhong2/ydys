...
import com.tphy.hospitaldoctor.zxing.camera.CameraManager;
import com.tphy.hospitaldoctor.zxing.decoding.CaptureActivityHandler;
import com.tphy.hospitaldoctor.zxing.decoding.InactivityTimer;
import com.tphy.hospitaldoctor.zxing.decoding.RGBLuminanceSource;
import com.tphy.hospitaldoctor.zxing.view.ViewfinderView;
 ...
 */
                                ...
                                intent.putExtra("QRMSG", result.getText());
...
//                                startActivity(intent);
    ...
    public void handleDecode(Result result) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            try {
                String qrMsg = new String(resultString.getBytes(), "UTF-8");
/**
 * 修改此处
 *
 */
