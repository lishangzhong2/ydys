...
public class ActivityUtils {
    ...
    public void showLongToast(CharSequence msg) {
        Activity activity = getActivity();
        if (activity != null) {
            if (toast == null) toast = Toast.makeText(activity, msg, Toast.LENGTH_LONG);
            toast.setText(msg);
            toast.show();
        }
    }
    ...
    public static String formatDuring(Date begin, Date end) {
        return formatDuring(end.getTime() - begin.getTime(), 0);
    }
    ...
    * */
    ...
    //弹挡板
    public void showProgressdialog(Activity act, String message){
        if (baseDialog==null){
            baseDialog = new ProgressDialog(act);
        }
