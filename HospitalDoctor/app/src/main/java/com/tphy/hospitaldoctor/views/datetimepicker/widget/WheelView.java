package com.tphy.hospitaldoctor.views.datetimepicker.widget;
...
import com.tphy.hospitaldoctor.views.datetimepicker.adapter.WheelAdapter;
import com.tphy.hospitaldoctor.views.datetimepicker.common.IPickerViewData;
import com.tphy.hospitaldoctor.views.datetimepicker.common.InertiaTimerTask;
import com.tphy.hospitaldoctor.views.datetimepicker.common.LineConfig;
import com.tphy.hospitaldoctor.views.datetimepicker.common.MessageHandler;
import com.tphy.hospitaldoctor.views.datetimepicker.common.OnItemPickedRunnable;
import com.tphy.hospitaldoctor.views.datetimepicker.common.SmoothScrollTimerTask;
import com.tphy.hospitaldoctor.views.datetimepicker.listener.OnItemPickListener;
import com.tphy.hospitaldoctor.views.datetimepicker.listener.WheelViewGestureListener;
...
//        AT MOST：父节点要求其子节点的大小不能超过某个最大值，其子节点以及其他子孙节点的大小都需要小于这个值
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //可见的item数组
        Object drawItemCount[] = new Object[itemsVisible];
...
//            float ratio  = lineConfig.getRatio();
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if(!isCenterLabel&&!TextUtils.isEmpty(label) &&!TextUtils.isEmpty(getContentText(drawItemCount[counter]))){
...
//                measuredOutContentStart(contentText);
    ...
    private void isCenterLabel(Boolean isCenterLabel) {
