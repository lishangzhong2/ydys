package com.tphy.hospitaldoctor.views.top_snackbar;
...
import static com.tphy.hospitaldoctor.views.top_snackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;
...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
     ...
     * @see BaseTransientBottomBar#addCallback(BaseTransientBottomBar.BaseCallback)
     */
    public abstract static class BaseCallback<B> {
         ...
         */
        public void onDismissed(B transientBottomBar, @BaseTransientBottomBar.BaseCallback.DismissEvent int event) {
            // empty
        }
